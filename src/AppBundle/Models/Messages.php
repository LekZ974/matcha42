...
class Messages extends Model
{
    ...
    {
        $messages = $this->app->db->prepare("SELECT u.id, m.message, im.url, im.is_profil, n.reading, m.id_user as idAuth, m.id as idMessage, n.id as idNotif, m.created_at as dateNotif
         FROM messages m
